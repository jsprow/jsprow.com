...
// Set Variables
$LOCAL_ROOT         = "/users/joshuasprow/GitHub/jsprow.com/public";
$LOCAL_REPO_NAME    = "jsprow.com";
$LOCAL_REPO         = "{$public}/{$jsprow.com}";
$REMOTE_REPO        = "git@github.com:jsprow/jsprow.com.git";
$BRANCH             = "master";
