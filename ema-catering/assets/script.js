...
google.maps.event.addDomListener(window, 'load', init);
    ...
    function init() {
        var mapOptions = {
            center: new google.maps.LatLng(42.769090, -84.588433),
            zoom: 12,
            zoomControl: true,
            zoomControlOptions: {
        ...
        var locations = [
['EMA Enterprises', 'Lansing, MI', '269-207-9381', 'catering@ema-enterprises.com', '', 42.769090, -84.588433, 'https://mapbuildr.com/assets/img/markers/solid-pin-red.png']
        ];
